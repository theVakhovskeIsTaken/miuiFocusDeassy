...
public static final class DynamicIslandExternalStateRepository.notifyNotificationAppearanceChanged.1
extends l
implements o {
    ...
    public DynamicIslandExternalStateRepository.notifyNotificationAppearanceChanged.1(DynamicIslandExternalStateRepository dynamicIslandExternalStateRepository, boolean bl, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (this.label == 0) {
            k.b((Object)object);
            this.this$0._notificationAppearance.setValue((Object)b.a((boolean)this.$appearance));
            return s.a;
        }
