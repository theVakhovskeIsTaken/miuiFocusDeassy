...
public static final class DynamicIslandExternalStateRepository.notifyMiPlayShowStateChanged.1
extends l
implements o {
    ...
    public DynamicIslandExternalStateRepository.notifyMiPlayShowStateChanged.1(DynamicIslandExternalStateRepository dynamicIslandExternalStateRepository, boolean bl, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (this.label == 0) {
            k.b((Object)object);
            this.this$0._miPlayShow.setValue((Object)b.a((boolean)this.$miplayShow));
            return s.a;
        }
