...
public static final class DynamicIslandExternalStateRepository.notifyDeviceInteractive.1
extends l
implements o {
    final boolean $value;
    int label;
    ...
    public DynamicIslandExternalStateRepository.notifyDeviceInteractive.1(DynamicIslandExternalStateRepository dynamicIslandExternalStateRepository, boolean bl, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (this.label == 0) {
            k.b((Object)object);
            this.this$0._isDeviceInteractive.setValue((Object)b.a((boolean)this.$value));
            return s.a;
        }
