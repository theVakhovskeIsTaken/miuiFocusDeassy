...
public static final class DynamicIslandSizeRepository$padContentViewDimensions$lambda$4$.inlined.map.2<T>
implements g {
    final g $this_unsafeFlow;
    final DynamicIslandSizeRepository this$0;

    public DynamicIslandSizeRepository$padContentViewDimensions$lambda$4$.inlined.map.2(g g2, DynamicIslandSizeRepository dynamicIslandSizeRepository) {
