...
public static final class DynamicIslandExternalStateRepository.notifyNotificationVisibleChanged.1
extends l
implements o {
    ...
    public DynamicIslandExternalStateRepository.notifyNotificationVisibleChanged.1(DynamicIslandExternalStateRepository dynamicIslandExternalStateRepository, boolean bl, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (this.label == 0) {
            k.b((Object)object);
            this.this$0._notificationVisible.setValue((Object)b.a((boolean)this.$visible));
            return s.a;
        }
