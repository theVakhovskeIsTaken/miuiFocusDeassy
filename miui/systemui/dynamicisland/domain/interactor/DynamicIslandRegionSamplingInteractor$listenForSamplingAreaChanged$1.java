...
public static final class DynamicIslandRegionSamplingInteractor.listenForSamplingAreaChanged.1
extends l
implements o {
    int label;
    final DynamicIslandRegionSamplingInteractor this$0;

    public DynamicIslandRegionSamplingInteractor.listenForSamplingAreaChanged.1(DynamicIslandRegionSamplingInteractor dynamicIslandRegionSamplingInteractor, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (n != 0) {
            ...
            k.b((Object)object);
            object = this.this$0.statusBarAreaRepository.getStatusBarArea();
