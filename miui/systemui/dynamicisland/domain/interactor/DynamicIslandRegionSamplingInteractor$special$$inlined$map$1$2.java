...
public static final class DynamicIslandRegionSamplingInteractor$special$.inlined.map.2<T>
implements g {
    final g $this_unsafeFlow;

    public DynamicIslandRegionSamplingInteractor$special$.inlined.map.2(g g2) {
