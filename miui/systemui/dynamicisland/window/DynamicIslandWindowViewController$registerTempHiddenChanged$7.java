...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandWindowViewController$registerTempHiddenChanged$7", f="DynamicIslandWindowViewController.kt", l={470}, m="invokeSuspend")
public static final class DynamicIslandWindowViewController.registerTempHiddenChanged.7
extends l
implements o {
    int label;
    final DynamicIslandWindowViewController this$0;

    public DynamicIslandWindowViewController.registerTempHiddenChanged.7(DynamicIslandWindowViewController dynamicIslandWindowViewController, d d2) {
    ...
    public final Object invokeSuspend(Object g2) {
        ...
        if (n != 0) {
            ...
            k.b((Object)g2);
            u u2 = this.this$0.getWindowState().getBouncerShowing();
