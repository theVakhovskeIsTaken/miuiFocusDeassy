...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandSafeguardsController$start$2", f="DynamicIslandSafeguardsController.kt", l={79}, m="invokeSuspend")
public static final class DynamicIslandSafeguardsController.start.2
extends l
implements o {
    int label;
    final DynamicIslandSafeguardsController this$0;

    public DynamicIslandSafeguardsController.start.2(DynamicIslandSafeguardsController dynamicIslandSafeguardsController, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (n != 0) {
            ...
            k.b((Object)object);
            object = this.this$0.getWindowViewController().isAppAnimRunning();
