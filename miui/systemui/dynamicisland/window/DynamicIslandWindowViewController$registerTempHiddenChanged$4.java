...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandWindowViewController$registerTempHiddenChanged$4", f="DynamicIslandWindowViewController.kt", l={450}, m="invokeSuspend")
public static final class DynamicIslandWindowViewController.registerTempHiddenChanged.4
extends l
implements o {
    int label;
    final DynamicIslandWindowViewController this$0;

    public DynamicIslandWindowViewController.registerTempHiddenChanged.4(DynamicIslandWindowViewController dynamicIslandWindowViewController, d d2) {
