...
public static final class DynamicIslandWindowViewController$special$.inlined.map.2<T>
implements g {
    final g $this_unsafeFlow;

    public DynamicIslandWindowViewController$special$.inlined.map.2(g g2) {
