...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandWindowViewController$registerTempHiddenChanged$10", f="DynamicIslandWindowViewController.kt", l={498}, m="invokeSuspend")
public static final class DynamicIslandWindowViewController.registerTempHiddenChanged.10
extends l
implements o {
    int label;
    final DynamicIslandWindowViewController this$0;

    public DynamicIslandWindowViewController.registerTempHiddenChanged.10(DynamicIslandWindowViewController dynamicIslandWindowViewController, d d2) {
