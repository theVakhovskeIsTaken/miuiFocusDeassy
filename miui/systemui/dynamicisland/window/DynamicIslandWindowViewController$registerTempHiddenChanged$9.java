...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandWindowViewController$registerTempHiddenChanged$9", f="DynamicIslandWindowViewController.kt", l={490}, m="invokeSuspend")
public static final class DynamicIslandWindowViewController.registerTempHiddenChanged.9
extends l
implements o {
    int label;
    final DynamicIslandWindowViewController this$0;

    public DynamicIslandWindowViewController.registerTempHiddenChanged.9(DynamicIslandWindowViewController dynamicIslandWindowViewController, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (n != 0) {
            ...
            k.b((Object)object);
            object = this.this$0.getExternalStateRepository().isKeyguardShowing();
