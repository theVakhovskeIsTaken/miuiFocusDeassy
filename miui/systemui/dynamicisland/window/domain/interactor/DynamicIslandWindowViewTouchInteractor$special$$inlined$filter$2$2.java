...
public static final class DynamicIslandWindowViewTouchInteractor$special$.inlined.filter.2<T>
implements g {
    final g $this_unsafeFlow;

    public DynamicIslandWindowViewTouchInteractor$special$.inlined.filter.2(g g2) {
