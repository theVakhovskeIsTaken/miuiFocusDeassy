...
public static final class DynamicIslandWindowViewTouchInteractor$start$2$invokeSuspend$.inlined.filter.2<T>
implements g {
    final g $this_unsafeFlow;

    public DynamicIslandWindowViewTouchInteractor$start$2$invokeSuspend$.inlined.filter.2(g g2) {
