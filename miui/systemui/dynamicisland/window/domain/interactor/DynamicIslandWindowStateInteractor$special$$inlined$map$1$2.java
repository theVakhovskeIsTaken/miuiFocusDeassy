...
public static final class DynamicIslandWindowStateInteractor$special$.inlined.map.2<T>
implements g {
    final g $this_unsafeFlow;

    public DynamicIslandWindowStateInteractor$special$.inlined.map.2(g g2) {
