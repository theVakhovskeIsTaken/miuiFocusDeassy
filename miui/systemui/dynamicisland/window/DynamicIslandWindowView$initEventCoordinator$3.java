...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandWindowView$initEventCoordinator$3", f="DynamicIslandWindowView.kt", l={338}, m="invokeSuspend")
public static final class DynamicIslandWindowView.initEventCoordinator.3
extends l
implements o {
    int label;
    final DynamicIslandWindowView this$0;

    public DynamicIslandWindowView.initEventCoordinator.3(DynamicIslandWindowView dynamicIslandWindowView, d d2) {
