...
@f(c="miui.systemui.dynamicisland.window.content.ui.viewbinder.DynamicIslandBaseContentViewBinder$bind$1$6", f="DynamicIslandBaseContentViewBinder.kt", l={68}, m="invokeSuspend")
public static final class DynamicIslandBaseContentViewBinder.bind.6
extends l
implements o {
    ...
    public DynamicIslandBaseContentViewBinder.bind.6(DynamicIslandSizeRepository dynamicIslandSizeRepository, DynamicIslandBaseContentView dynamicIslandBaseContentView, d d2) {
    ...
    public final Object invokeSuspend(Object g2) {
        ...
        if (n != 0) {
            ...
            k.b((Object)g2);
            I i = this.$sizeRepository.getPadContentViewDimensions();
            g2 = new g(this.$view){
                final DynamicIslandBaseContentView $view;
                {
                    this.$view = dynamicIslandBaseContentView;
