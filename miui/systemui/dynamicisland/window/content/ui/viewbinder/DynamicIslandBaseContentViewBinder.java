...
public final class DynamicIslandBaseContentViewBinder {
    ...
    public final void bind(DynamicIslandBaseContentView dynamicIslandBaseContentView, DynamicIslandSizeRepository dynamicIslandSizeRepository, boolean bl, DynamicIslandData dynamicIslandData) {
        ...
        dynamicIslandBaseContentView.setSizeRepository$miui_dynamicisland_release(dynamicIslandSizeRepository);
        dynamicIslandBaseContentView.setCurrentIslandData(dynamicIslandData);
        RepeatWhenAttachedKt.repeatWhenAttached$default((View)dynamicIslandBaseContentView, null, (p)new p(dynamicIslandSizeRepository, dynamicIslandBaseContentView, bl, null){
            ...
            public final Object invokeSuspend(Object object) {
                ...
                if (this.label == 0) {
                    k.b((Object)object);
                    object = (E)this.L$0;
                    f.b((E)object, null, null, (U0.o)new U0.o(this.$sizeRepository, this.$view, null){
                        final DynamicIslandSizeRepository $sizeRepository;
                        final DynamicIslandBaseContentView $view;
                        int label;
                        {
                    ...
                    f.b((E)object, null, null, (U0.o)new U0.o(this.$sizeRepository, this.$propOnce, this.$view, null){
                        final boolean $propOnce;
                        final DynamicIslandSizeRepository $sizeRepository;
                        final DynamicIslandBaseContentView $view;
                        int label;
