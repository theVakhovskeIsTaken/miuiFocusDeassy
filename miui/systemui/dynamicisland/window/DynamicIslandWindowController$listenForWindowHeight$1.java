...
@f(c="miui.systemui.dynamicisland.window.DynamicIslandWindowController$listenForWindowHeight$1", f="DynamicIslandWindowController.kt", l={117}, m="invokeSuspend")
public static final class DynamicIslandWindowController.listenForWindowHeight.1
extends l
implements o {
    int label;
    final DynamicIslandWindowController this$0;

    public DynamicIslandWindowController.listenForWindowHeight.1(DynamicIslandWindowController dynamicIslandWindowController, d d2) {
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (n != 0) {
            ...
            k.b((Object)object);
            object = this.this$0.windowStateInteractor.getWindowHeight();
