...
public static final class DynamicIslandExternalTouchInteractor$special$.inlined.filter.2<T>
implements g {
    final g $this_unsafeFlow;
    final DynamicIslandExternalTouchInteractor this$0;

    public DynamicIslandExternalTouchInteractor$special$.inlined.filter.2(g g2, DynamicIslandExternalTouchInteractor dynamicIslandExternalTouchInteractor) {
