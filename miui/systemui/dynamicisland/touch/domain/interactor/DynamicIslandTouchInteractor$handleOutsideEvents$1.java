...
@M0.f(c="miui.systemui.dynamicisland.touch.domain.interactor.DynamicIslandTouchInteractor$handleOutsideEvents$1", f="DynamicIslandTouchInteractor.kt", l={118}, m="invokeSuspend")
public static final class DynamicIslandTouchInteractor.handleOutsideEvents.1
extends l
implements o {
    int label;
    final DynamicIslandTouchInteractor this$0;

    public DynamicIslandTouchInteractor.handleOutsideEvents.1(DynamicIslandTouchInteractor dynamicIslandTouchInteractor, d d2) {
    ...
    public final Object invokeSuspend(Object g2) {
        ...
        if (n != 0) {
            ...
            k.b((Object)g2);
            f f2 = this.this$0.windowViewTouchInteractor.getOutsideTouchEvent();
