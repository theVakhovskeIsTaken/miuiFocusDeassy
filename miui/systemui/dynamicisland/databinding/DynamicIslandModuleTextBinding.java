...
public final class DynamicIslandModuleTextBinding
implements ViewBinding {
    ...
    private DynamicIslandModuleTextBinding(@NonNull FrameLayout frameLayout, @NonNull FrameLayout frameLayout2, @NonNull ViewStub viewStub, @NonNull ViewStub viewStub2, @NonNull View view, @NonNull ViewStub viewStub3) {
    ...
    public static DynamicIslandModuleTextBinding bind(@NonNull View view) {
        ...
        if (viewStub3 != null && (viewStub2 = (ViewStub)ViewBindings.findChildViewById((View)view, (int)(n = R.id.island_front_title_stub))) != null && (view2 = ViewBindings.findChildViewById((View)view, (int)(n = R.id.island_text_shade))) != null && (viewStub = (ViewStub)ViewBindings.findChildViewById((View)view, (int)(n = R.id.island_title_stub))) != null) {
            return new DynamicIslandModuleTextBinding(frameLayout, frameLayout, viewStub3, viewStub2, view2, viewStub);
        }
    ...
    public static DynamicIslandModuleTextBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return DynamicIslandModuleTextBinding.inflate(layoutInflater, null, false);
    }

    @NonNull
    public static DynamicIslandModuleTextBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean bl) {
        layoutInflater = layoutInflater.inflate(R.layout.dynamic_island_module_text, viewGroup, false);
        if (bl) {
            viewGroup.addView((View)layoutInflater);
        }
        return DynamicIslandModuleTextBinding.bind((View)layoutInflater);
    }
