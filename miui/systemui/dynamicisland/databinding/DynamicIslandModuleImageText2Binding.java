...
public final class DynamicIslandModuleImageText2Binding
implements ViewBinding {
    ...
    public static DynamicIslandModuleImageText2Binding bind(@NonNull View view) {
        ...
        if (view2 != null) {
            return new DynamicIslandModuleImageText2Binding(frameLayout, frameLayout, DynamicIslandModuleRightTextBinding.bind(view2));
        }
    ...
    public static DynamicIslandModuleImageText2Binding inflate(@NonNull LayoutInflater layoutInflater) {
        return DynamicIslandModuleImageText2Binding.inflate(layoutInflater, null, false);
    }

    @NonNull
    public static DynamicIslandModuleImageText2Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean bl) {
        layoutInflater = layoutInflater.inflate(R.layout.dynamic_island_module_image_text_2, viewGroup, false);
        if (bl) {
            viewGroup.addView((View)layoutInflater);
        }
        return DynamicIslandModuleImageText2Binding.bind((View)layoutInflater);
    }
