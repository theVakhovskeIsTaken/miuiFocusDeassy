...
public static final class WindowAnimState.Closed
extends WindowAnimState {
    private final boolean byAnimEvent;
    private final boolean freeform;
    private final boolean hasAnimate;

    public WindowAnimState.Closed(boolean bl, boolean bl2, boolean bl3) {
        this.freeform = bl;
        this.hasAnimate = bl2;
        this.byAnimEvent = bl3;
    }

    public /* synthetic */ WindowAnimState.Closed(boolean bl, boolean bl2, boolean bl3, int n, h h2) {
        if ((n & 4) != 0) {
            bl3 = true;
        }
        this(bl, bl2, bl3);
