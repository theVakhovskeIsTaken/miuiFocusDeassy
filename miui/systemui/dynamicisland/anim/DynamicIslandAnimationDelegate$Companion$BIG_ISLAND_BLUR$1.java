...
public static final class DynamicIslandAnimationDelegate.BIG_ISLAND_BLUR.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.BIG_ISLAND_BLUR.1() {
        super("dynamic_big_island_blur", 0.004f);
    }
