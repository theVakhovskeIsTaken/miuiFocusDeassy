...
public static final class DynamicIslandAnimationDelegate.CONTAINER_CLIP_TOP_PROGRESS.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.CONTAINER_CLIP_TOP_PROGRESS.1() {
        super("dynamic_container_clip_top_progress", 1.0f);
    }
