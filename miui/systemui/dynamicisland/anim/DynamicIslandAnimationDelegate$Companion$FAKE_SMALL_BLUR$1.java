...
public static final class DynamicIslandAnimationDelegate.FAKE_SMALL_BLUR.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.FAKE_SMALL_BLUR.1() {
        super("dynamic_fake_small_blur", 0.004f);
    }
