...
public static final class DynamicIslandAnimationDelegate.EXPANDED_SCALE_Y.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.EXPANDED_SCALE_Y.1() {
        super("dynamic_expanded_scale_y", 0.004f);
    }
