...
public static final class DynamicIslandAnimationDelegate.BIG_ISLAND_ALPHA.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.BIG_ISLAND_ALPHA.1() {
        super("dynamic_big_island_alpha", 0.004f);
    }
