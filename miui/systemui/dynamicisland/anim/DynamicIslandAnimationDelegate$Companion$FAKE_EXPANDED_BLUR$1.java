...
public static final class DynamicIslandAnimationDelegate.FAKE_EXPANDED_BLUR.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.FAKE_EXPANDED_BLUR.1() {
        super("dynamic_fake_expanded_blur", 0.004f);
    }
