...
public static final class DynamicIslandAnimationDelegate.BIG_ISLAND_TRANS_X.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.BIG_ISLAND_TRANS_X.1() {
        super("dynamic_big_island_trans_x", 0.004f);
    }
