...
public static final class DynamicIslandAnimationDelegate.CONTAINER_CLIP_BOTTOM_PROGRESS.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.CONTAINER_CLIP_BOTTOM_PROGRESS.1() {
        super("dynamic_container_clip_bottom_progress", 1.0f);
    }
