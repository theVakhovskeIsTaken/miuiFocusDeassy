...
public static final class DynamicIslandAnimationDelegate.EXPANDED_SCALE_X.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.EXPANDED_SCALE_X.1() {
        super("dynamic_expanded_scale_x", 0.004f);
    }
