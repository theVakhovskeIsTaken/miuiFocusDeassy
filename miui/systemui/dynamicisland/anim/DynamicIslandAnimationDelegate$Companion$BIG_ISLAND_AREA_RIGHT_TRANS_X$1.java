...
public static final class DynamicIslandAnimationDelegate.BIG_ISLAND_AREA_RIGHT_TRANS_X.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.BIG_ISLAND_AREA_RIGHT_TRANS_X.1() {
        super("big_island_area_right_trans_x", 1.0f);
    }
