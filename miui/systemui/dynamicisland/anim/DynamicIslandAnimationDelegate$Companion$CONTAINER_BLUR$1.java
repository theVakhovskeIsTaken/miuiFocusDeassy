...
public static final class DynamicIslandAnimationDelegate.CONTAINER_BLUR.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.CONTAINER_BLUR.1() {
        super("dynamic_container_blur_blur", 0.004f);
    }
