...
public static final class DynamicIslandAnimationDelegate.EXPANDED_ALPHA.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.EXPANDED_ALPHA.1() {
        super("dynamic_expanded_alpha", 0.004f);
    }
