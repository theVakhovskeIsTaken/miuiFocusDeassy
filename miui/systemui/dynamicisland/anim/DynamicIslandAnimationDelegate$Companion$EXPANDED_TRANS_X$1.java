...
public static final class DynamicIslandAnimationDelegate.EXPANDED_TRANS_X.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.EXPANDED_TRANS_X.1() {
        super("dynamic_expanded_trans_x", 0.004f);
    }
