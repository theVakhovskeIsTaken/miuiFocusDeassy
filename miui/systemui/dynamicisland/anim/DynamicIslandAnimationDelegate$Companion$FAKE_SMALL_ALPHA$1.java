...
public static final class DynamicIslandAnimationDelegate.FAKE_SMALL_ALPHA.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.FAKE_SMALL_ALPHA.1() {
        super("dynamic_fake_small_alpha", 0.00390625f);
    }
