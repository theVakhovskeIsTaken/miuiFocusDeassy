...
public static final class DynamicIslandAnimationDelegate.SMALL_ISLAND_ALPHA.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.SMALL_ISLAND_ALPHA.1() {
        super("dynamic_small_island_alpha", 0.004f);
    }
