...
public static final class DynamicIslandAnimationDelegate.BIG_ISLAND_TRANS_Y.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.BIG_ISLAND_TRANS_Y.1() {
        super("dynamic_big_island_trans_y", 1.0f);
    }
