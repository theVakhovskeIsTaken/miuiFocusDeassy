...
public static final class DynamicIslandAnimationDelegate.bigIslandChangedAnimation.1
extends DynamicIslandAnimListener {
    final DynamicIslandContentView $view;

    public DynamicIslandAnimationDelegate.bigIslandChangedAnimation.1(DynamicIslandAnimationDelegate dynamicIslandAnimationDelegate, DynamicIslandContentView dynamicIslandContentView) {
