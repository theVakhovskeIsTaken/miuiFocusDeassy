...
public static final class DynamicIslandAnimationDelegate.SMALL_ISLAND_SCALE.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.SMALL_ISLAND_SCALE.1() {
        super("dynamic_small_island_scale", 0.004f);
    }
