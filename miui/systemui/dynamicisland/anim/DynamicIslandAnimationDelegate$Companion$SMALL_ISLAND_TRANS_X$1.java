...
public static final class DynamicIslandAnimationDelegate.SMALL_ISLAND_TRANS_X.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.SMALL_ISLAND_TRANS_X.1() {
        super("dynamic_small_island_trans_x", 1.0f);
    }
