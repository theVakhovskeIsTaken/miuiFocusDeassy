...
public static final class DynamicIslandAnimationDelegate.SMALL_ISLAND_BLUR.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.SMALL_ISLAND_BLUR.1() {
        super("dynamic_small_island_blur", 0.004f);
    }
