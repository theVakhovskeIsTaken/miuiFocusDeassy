...
public static final class DynamicIslandAnimationDelegate.FAKE_BIG_ALPHA.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.FAKE_BIG_ALPHA.1() {
        super("dynamic_fake_big_alpha", 0.00390625f);
    }
