...
public static final class DynamicIslandAnimationDelegate.EXPANDED_BLUR.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.EXPANDED_BLUR.1() {
        super("dynamic_expanded_blur", 0.004f);
    }
