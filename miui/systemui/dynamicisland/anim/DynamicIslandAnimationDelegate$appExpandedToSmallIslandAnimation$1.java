...
public static final class DynamicIslandAnimationDelegate.appExpandedToSmallIslandAnimation.1
extends DynamicIslandAnimListener {
    ...
    public DynamicIslandAnimationDelegate.appExpandedToSmallIslandAnimation.1(DynamicIslandAnimationDelegate dynamicIslandAnimationDelegate, DynamicIslandContentView dynamicIslandContentView, boolean bl) {
    ...
    public void onCancel(Object object) {
        ...
        if (this.this$0.getIslandWindowAnimRunning() && !this.$isAppClose) {
            if (!this.this$0.windowView.getSupportMiniWindowEndPositionChange() || !((DynamicIslandBaseContentView)((Object)(object = this.$view))).pkgHasMultIslands((DynamicIslandContentView)((Object)object)) || this.this$0.getIslandStateChanged() && !(this.$view.getState() instanceof DynamicIslandState.Hidden)) {
                this.this$0.setViewVisible(this.$view, 0);
                object = this.$view.getFakeView();
                if (object != null) {
                    ((DynamicIslandContentFakeView)((Object)object)).setVisibility(4);
