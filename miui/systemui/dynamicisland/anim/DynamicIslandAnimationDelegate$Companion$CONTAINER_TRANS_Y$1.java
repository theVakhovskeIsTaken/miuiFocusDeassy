...
public static final class DynamicIslandAnimationDelegate.CONTAINER_TRANS_Y.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.CONTAINER_TRANS_Y.1() {
        super("dynamic_container_trans_y", 1.0f);
    }
