...
public static final class DynamicIslandAnimationDelegate.BIG_ISLAND_X.1
extends FloatProperty<DynamicIslandAnimationDelegate> {
    public DynamicIslandAnimationDelegate.BIG_ISLAND_X.1() {
        super("dynamic_big_island_x", 0.004f);
    }
