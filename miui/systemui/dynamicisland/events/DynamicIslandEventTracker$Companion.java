...
public static final class DynamicIslandEventTracker.Companion {
    private DynamicIslandEventTracker.Companion() {
    }

    public /* synthetic */ DynamicIslandEventTracker.Companion(h h2) {
        this();
    }
    ...
    public static /* synthetic */ void trackExpandedClick$default(DynamicIslandEventTracker.Companion companion, Context context, StatusBarNotification statusBarNotification, String string, Boolean bl, String string2, String string3, boolean bl2, int n, Object object) {
        if ((n & 0x40) != 0) {
            bl2 = false;
        }
