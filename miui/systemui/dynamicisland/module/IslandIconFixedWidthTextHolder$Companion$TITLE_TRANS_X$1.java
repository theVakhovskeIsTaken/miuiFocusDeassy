...
public static final class IslandIconFixedWidthTextHolder.TITLE_TRANS_X.1
extends FloatProperty<IslandIconFixedWidthTextHolder> {
    public IslandIconFixedWidthTextHolder.TITLE_TRANS_X.1() {
        super("dynamic_title_trans_x", 0.01f);
    }
