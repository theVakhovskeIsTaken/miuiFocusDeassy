...
public static final class IslandIconFixedWidthTextHolder.TITLE_SCALE_Y.1
extends FloatProperty<IslandIconFixedWidthTextHolder> {
    public IslandIconFixedWidthTextHolder.TITLE_SCALE_Y.1() {
        super("dynamic_title_scale_y", 0.01f);
    }
