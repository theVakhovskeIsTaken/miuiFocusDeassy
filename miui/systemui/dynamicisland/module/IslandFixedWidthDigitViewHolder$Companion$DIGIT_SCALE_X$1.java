...
public static final class IslandFixedWidthDigitViewHolder.DIGIT_SCALE_X.1
extends FloatProperty<IslandFixedWidthDigitViewHolder> {
    public IslandFixedWidthDigitViewHolder.DIGIT_SCALE_X.1() {
        super("dynamic_digit_scale_x", 0.01f);
    }
