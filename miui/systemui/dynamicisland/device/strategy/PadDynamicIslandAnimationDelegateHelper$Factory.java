...
public static interface PadDynamicIslandAnimationDelegateHelper.Factory
extends DynamicIslandAnimationDelegateHelper.Factory {
    @Override
    public PadDynamicIslandAnimationDelegateHelper create(DynamicIslandBaseContentView var1, DynamicIslandAnimationController var2, SmallIslandStateHandler var3, BigIslandStateHandler var4, ExpandedStateHandler var5, DynamicIslandWindowView var6);
}
