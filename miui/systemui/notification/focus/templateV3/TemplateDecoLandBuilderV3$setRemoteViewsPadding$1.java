...
public static final class TemplateDecoLandBuilderV3.setRemoteViewsPadding.1
extends l
implements U0.o {
    final View $view;
    int label;
    ...
    public TemplateDecoLandBuilderV3.setRemoteViewsPadding.1(View view, TemplateDecoLandBuilderV3 templateDecoLandBuilderV3, d d2) {
        this.$view = view;
