...
public static final class FocusNotificationController.inflateCallBack.1.onInflateFailed.1
extends l
implements o {
    ...
    public FocusNotificationController.inflateCallBack.1.onInflateFailed.1(String string, FocusNotificationController focusNotificationController, FocusNotificationContent focusNotificationContent, d d2) {
        this.$key = string;
    ...
    public final Object invokeSuspend(Object object) {
        ...
        if (this.label == 0) {
            ...
            this.this$0.inflateResult.put(this.$key, b.a((boolean)false));
