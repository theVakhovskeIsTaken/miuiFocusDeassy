...
public final class ModuleDecoPortImageTextHighlightViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoPortImageTextHighlightViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public void bind(Template template, StatusBarNotification statusBarNotification) {
        ...
        if ((object = template.getHighlightInfo()) != null && ((HighlightInfo)object).getType() == 1) {
    ...
    public void initView(String string) {
        ...
        Object var3_3 = null;
        string = bl ? LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_image_text_highlight_timer, this.getRootView()) : LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_image_text_highlight_sport, this.getRootView());
