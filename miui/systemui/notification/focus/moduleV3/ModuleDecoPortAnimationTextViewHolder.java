...
import miui.systemui.notification.focus.moduleV3.l;
...
public final class ModuleDecoPortAnimationTextViewHolder
...
implements FullAodStatusManager.IFullAodStatusObserver {
    ...
    public ModuleDecoPortAnimationTextViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public static final /* synthetic */ LottieAnimationView access$getFocusAnimation$p(ModuleDecoPortAnimationTextViewHolder moduleDecoPortAnimationTextViewHolder) {
        return moduleDecoPortAnimationTextViewHolder.focusAnimation;
    }

    public static final /* synthetic */ boolean access$isAutoPlay$p(ModuleDecoPortAnimationTextViewHolder moduleDecoPortAnimationTextViewHolder) {
        return moduleDecoPortAnimationTextViewHolder.isAutoPlay;
    }

    public static /* synthetic */ void c(ModuleDecoPortAnimationTextViewHolder moduleDecoPortAnimationTextViewHolder, Template template, h h2) {
        ModuleDecoPortAnimationTextViewHolder.playAnimation$lambda$2(moduleDecoPortAnimationTextViewHolder, template, h2);
    }
    ...
    private final void playAnimation(Template object, StatusBarNotification object2) {
        ...
        p.s((Context)ModuleViewHolder.getContext$default(this, false, 1, null), (int)n).d((H)new l(this, (Template)object));
     ...
     */
    private static final void playAnimation$lambda$2(ModuleDecoPortAnimationTextViewHolder var0, Template var1_1, h var2_2) {
        block6: {
    ...
    public void fullAodStatusChanged(boolean bl) {
        f.b((E)this.getScope(), null, null, (U0.o)new U0.o(this, bl, null){
            ...
            public final Object invokeSuspend(Object object) {
                ...
                if (this.label == 0) {
                    k.b((Object)object);
                    if (ModuleDecoPortAnimationTextViewHolder.access$getFocusAnimation$p(this.this$0) == null) {
                        return s.a;
                    }
                    if (this.$fullAodStatus) {
                        object = ModuleDecoPortAnimationTextViewHolder.access$getFocusAnimation$p(this.this$0);
                        if (object != null) {
                    ...
                    } else if (ModuleDecoPortAnimationTextViewHolder.access$isAutoPlay$p(this.this$0) && (object = ModuleDecoPortAnimationTextViewHolder.access$getFocusAnimation$p(this.this$0)) != null) {
    ...
    public void initView(String string) {
        ...
        Object var2_2 = null;
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_animation_text, this.getRootView()));
        string = this.getView();
    ...
    public void onDetach() {
        ...
        f.b((E)this.getScope(), null, null, (U0.o)new U0.o(this, null){
            ...
            public final Object invokeSuspend(Object object) {
                ...
                if (this.label == 0) {
                    k.b((Object)object);
                    LottieResUtils.cancelLottieAnimate$default((LottieResUtils)LottieResUtils.INSTANCE, (LottieAnimationView)ModuleDecoPortAnimationTextViewHolder.access$getFocusAnimation$p(this.this$0), (boolean)false, (int)2, null);
                    return s.a;
                }
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
