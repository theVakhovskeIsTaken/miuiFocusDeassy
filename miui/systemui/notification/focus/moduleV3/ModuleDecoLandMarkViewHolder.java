...
public final class ModuleDecoLandMarkViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoLandMarkViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
            ...
            block7: {
                ...
                switch (string.hashCode()) {
                    ...
                    case -1211998214: {
                        ...
                        this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_land_mark_3, this.getRootView()));
                        break block6;
                    }
                    case -1211998215: {
                        if (!string.equals("moduleMark2")) break;
                        this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_land_mark_2, this.getRootView()));
                        break block6;
                    }
                    case -1211998216: {
                ...
                this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_land_mark_4, this.getRootView()));
                break block6;
            }
            this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_land_mark_1, this.getRootView()));
        }
        string = this.getView();
        Object var2_2 = null;
