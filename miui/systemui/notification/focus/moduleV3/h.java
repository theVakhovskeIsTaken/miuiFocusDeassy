...
implements View.OnClickListener {
    ...
    public /* synthetic */ h(Notification.Action action, ModuleDecoLandButtonViewHolder moduleDecoLandButtonViewHolder, StatusBarNotification statusBarNotification) {
        this.a = action;
    ...
    public final void onClick(View view) {
        ModuleDecoLandButtonViewHolder.c(this.a, this.b, this.c, view);
    }
}
