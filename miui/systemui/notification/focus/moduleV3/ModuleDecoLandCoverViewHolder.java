...
public final class ModuleDecoLandCoverViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoLandCoverViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public void bind(Template template, StatusBarNotification statusBarNotification) {
        ...
        if ((object = (object = template.getPicInfo()) != null ? ((PicInfo)object).getType() : null) != null) {
            template = this.iconContainer;
            if (template != null) {
    ...
    public void initView(String string) {
        ...
        Object var2_2 = null;
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_land_cover, this.getRootView()));
        string = this.getView();
