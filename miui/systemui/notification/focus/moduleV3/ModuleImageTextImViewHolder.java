...
public final class ModuleImageTextImViewHolder
extends ModuleViewHolder {
    ...
    public ModuleImageTextImViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl, boolean bl2) {
...
lbl11:
    ...
    public void initView(String string) {
        ...
        this.setView(LayoutInflater.from((Context)this.getContext(this.island)).inflate(R.layout.focus_notification_module_image_text_im, this.getRootView()));
        string = this.getView();
        Object var2_2 = null;
