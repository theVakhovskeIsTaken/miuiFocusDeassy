...
public final class ModuleMultiProgressViewHolder
extends ModuleViewHolder {
    ...
    public ModuleMultiProgressViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl, boolean bl2) {
    ...
    private final List<NotificationProgressDrawable.Part> convertToDrawableParts(int n, int n2, String object) {
        ...
        for (int i = 0; i < n2; ++i) {
            ...
            bl = i > n4;
            arrayList.add(new NotificationProgressDrawable.Point(null, n5, bl, i - n4));
        }
        object = this.TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(" get Parts=");
        ...
        if ((object = ((Template)object).getMultiProgressInfo()) != null) {
            if (((MultiProgressInfo)object).getProgress() >= 0 && ((MultiProgressInfo)object).getPoints() >= 0) {
                if (((MultiProgressInfo)object).getProgress() > 100) {
                    Log.w((String)this.TAG, (String)" multiProgressInfo progress > 100, reduced to 100");
                    ((MultiProgressInfo)object).setProgress(100);
                } else if (((MultiProgressInfo)object).getPoints() > 4) {
                    Log.w((String)this.TAG, (String)" multiProgressInfo points > 4, limited to 4");
                ...
                Log.e((String)this.TAG, (String)" multiProgressInfo empty or values are negative !!!");
            }
        }
    }
    ...
    public void initView(String string) {
        ...
        this.setView(LayoutInflater.from((Context)this.getContext(this.island)).inflate(R.layout.focus_notification_module_multi_progress, this.getRootView()));
        string = this.getView();
        Object var2_2 = null;
