...
public final class ModuleTinyCoverViewHolder
extends ModuleViewHolder {
    ...
    public ModuleTinyCoverViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public void initView(String string) {
        ...
        Object var2_2 = null;
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_tiny_cover, this.getRootView()));
        string = this.getView();
        ...
        string = var2_2;
        if (view != null) {
            string = (TextView)view.findViewById(R.id.focus_sub_content);
        }
