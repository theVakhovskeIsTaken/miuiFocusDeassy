...
public final class ModuleTinyMultiProgressViewHolder
extends ModuleViewHolder {
    ...
    public ModuleTinyMultiProgressViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public void initView(String string) {
        ...
        Object var2_2 = null;
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_tiny_multi_progress, this.getRootView()));
        string = this.getView();
