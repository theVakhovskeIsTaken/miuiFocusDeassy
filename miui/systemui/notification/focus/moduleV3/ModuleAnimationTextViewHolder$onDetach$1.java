...
@f(c="miui.systemui.notification.focus.moduleV3.ModuleAnimationTextViewHolder$onDetach$1", f="ModuleAnimationTextViewHolder.kt", l={}, m="invokeSuspend")
public static final class ModuleAnimationTextViewHolder.onDetach.1
extends l
implements o {
    int label;
    final ModuleAnimationTextViewHolder this$0;

    public ModuleAnimationTextViewHolder.onDetach.1(ModuleAnimationTextViewHolder moduleAnimationTextViewHolder, d d2) {
