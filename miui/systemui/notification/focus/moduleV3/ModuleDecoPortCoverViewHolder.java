...
public final class ModuleDecoPortCoverViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoPortCoverViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public void initView(String string) {
        ...
        Object var2_2 = null;
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_cover, this.getRootView()));
        string = this.getView();
