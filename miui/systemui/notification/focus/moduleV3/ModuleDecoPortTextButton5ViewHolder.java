...
public final class ModuleDecoPortTextButton5ViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoPortTextButton5ViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    public void bind(Template object, StatusBarNotification object2) {
        ...
        if ((object = ((Template)object).getHighlightInfoV3()) != null && (object = ((HighlightInfoV3)object).getActionInfo()) != null && !TextUtils.isEmpty((CharSequence)((ActionInfo)object).getAction())) {
            ...
            if ((object3 = ((ActionInfo)object).getActionTitleColor()) != null && (object2 = this.actionTitleView) != null) {
                object2.updateTextWithNewAppearance((CharSequence)Html.fromHtml((String)((ActionInfo)object).getActionTitle()), Integer.valueOf(Color.parseColor((String)object3)));
            }
    ...
    public void initView(String string) {
        ...
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_button_5, this.getRootView()));
        string = this.getView();
