...
@f(c="miui.systemui.notification.focus.moduleV3.ModuleTinyAnimationTextViewHolder$onDetach$1", f="ModuleTinyAnimationTextViewHolder.kt", l={}, m="invokeSuspend")
public static final class ModuleTinyAnimationTextViewHolder.onDetach.1
extends l
implements o {
    int label;
    final ModuleTinyAnimationTextViewHolder this$0;

    public ModuleTinyAnimationTextViewHolder.onDetach.1(ModuleTinyAnimationTextViewHolder moduleTinyAnimationTextViewHolder, d d2) {
