...
public final class ModuleDecoLandMarkTextImageViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoLandMarkTextImageViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl, boolean bl2) {
    ...
    public void initView(String string) {
        ...
        this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_tiny_mark_text_image, this.getRootView()));
        string = this.getView();
        Object var2_2 = null;
