...
public final class ModuleDecoPortMarkViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoPortMarkViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
            ...
            block7: {
                ...
                switch (string.hashCode()) {
                    ...
                    case -1211998215: {
                        ...
                        this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_port_mark_2, this.getRootView()));
                        break block6;
                    }
                    case -1211998216: {
                ...
                this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_port_mark_4, this.getRootView()));
                break block6;
            }
            this.setView(LayoutInflater.from((Context)this.getCtx()).inflate(R.layout.focus_notification_module_deco_prot_mark_1, this.getRootView()));
        }
        string = this.getView();
        Object var2_2 = null;
