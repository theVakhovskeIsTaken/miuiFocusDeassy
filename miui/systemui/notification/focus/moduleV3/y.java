...
implements View.OnClickListener {
    ...
    public /* synthetic */ y(Notification.Action action, ModuleTinyButtonViewHolder moduleTinyButtonViewHolder, StatusBarNotification statusBarNotification) {
        this.a = action;
    ...
    public final void onClick(View view) {
        ModuleTinyButtonViewHolder.c(this.a, this.b, this.c, view);
    }
}
