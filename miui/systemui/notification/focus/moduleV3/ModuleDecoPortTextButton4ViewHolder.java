...
public final class ModuleDecoPortTextButton4ViewHolder
extends ModuleViewHolder {
    ...
    public ModuleDecoPortTextButton4ViewHolder(Context context, Context context2, ViewGroup viewGroup, boolean bl) {
    ...
    private final void checkAndCompressModuleButton4Views(Template object, StatusBarNotification object2) {
        ...
        if ((object2 = object2 != null ? Integer.valueOf(object2.size()) : null) != null && (Integer)object2 == 1) {
            ...
            if (object != null && (object2 = ((ActionInfo)object).getActionBgColor()) != null) {
                string = this.getCtx().getResources().getDrawable(R.drawable.focus_button_background);
                o.e((Object)string, (String)"null cannot be cast to non-null type android.graphics.drawable.GradientDrawable");
                string = (GradientDrawable)string;
                string.setColor(Color.parseColor((String)object2));
                object2 = this.action1;
                o.d((Object)object2);
                object2.setBackground((Drawable)string);
            }
            if (object != null && (string = ((ActionInfo)object).getActionTitleColor()) != null && (object2 = this.action1TitleView) != null) {
                object2.setTextColor(Color.parseColor((String)string));
            }
            object2 = string2;
            if (object != null) {
            ...
            if (object2 != null && (string2 = ((ActionInfo)object2).getActionBgColor()) != null) {
                drawable2 = this.getCtx().getResources().getDrawable(R.drawable.focus_button_background);
                ...
                drawable2.setColor(Color.parseColor((String)string2));
                string2 = this.action1;
                o.d((Object)string2);
                string2.setBackground(drawable2);
            }
            if ((object = (object = ((Template)object).getTextButton()) != null ? (ActionInfo)object.get(1) : null) != null && (string2 = ((ActionInfo)object).getActionBgColor()) != null) {
                drawable2 = this.getCtx().getResources().getDrawable(R.drawable.focus_button_background);
                o.e((Object)drawable2, (String)"null cannot be cast to non-null type android.graphics.drawable.GradientDrawable");
                drawable2 = (GradientDrawable)drawable2;
                drawable2.setColor(Color.parseColor((String)string2));
            ...
            if (object2 != null && (string2 = ((ActionInfo)object2).getActionTitleColor()) != null && (drawable2 = this.action2TitleView) != null) {
                drawable2.setTextColor(Color.parseColor((String)string2));
            }
            ...
            if (object != null && (string2 = ((ActionInfo)object).getActionTitleColor()) != null && (object2 = this.action2TitleView) != null) {
                object2.setTextColor(Color.parseColor((String)string2));
            }
            object2 = string;
            if (object != null) {
                object2 = ((ActionInfo)object).getActionTitle();
    ...
    public void initView(String string) {
        ...
        this.setView(LayoutInflater.from((Context)ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_button_4, this.getRootView()));
        string = this.getView();
